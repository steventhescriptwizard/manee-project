        ...
        <div class="relative aspect-[3/4] overflow-hidden bg-gray-50">
            ...
            <div class="absolute top-2 right-3 z-10" 
                ...
                <button 
                    ...
                    "
                    class="flex items-center justify-center p-2 rounded-full bg-white/80 backdrop-blur-sm shadow-md transition-all border border-gray-100 hover:scale-110 active:scale-90"
                    :class="isWishlisted ? 'text-brandRed' : 'text-gray-400'"
                >
