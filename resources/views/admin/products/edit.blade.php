                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div x-data="{ price: {{ old('price', $product->price) }}, exchangeRate: 15500 }">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" x-model="price" class="w-full pl-8 rounded-lg border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:ring-blue-600 focus:border-blue-600">
                        </div>
