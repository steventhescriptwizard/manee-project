...
@section('content')
<div class="relative flex min-h-screen flex-col font-body text-[#111318] dark:text-white bg-white dark:bg-[#111721]">
    
    <!-- Hero Section -->
    <section class="relative w-full py-24 md:py-32 lg:py-40 overflow-hidden mt-16 md:mt-0">
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-gradient-to-r from-white/90 via-white/70 to-transparent z-10 dark:from-[#111721]/95 dark:via-[#111721]/80"></div>
        ...
        <div class="relative z-20 mx-auto max-w-7xl px-6">
            <div class="max-w-2xl animate-fade-in-up">
                <span class="mb-4 inline-block rounded-full bg-brandLightBlue/20 px-4 py-1.5 text-sm font-semibold text-gray-800 dark:text-brandLightBlue">
                    Since 2023
                </span>
                <h1 class="mb-6 font-display text-5xl font-bold leading-tight tracking-tight text-[#111318] dark:text-white md:text-6xl lg:text-7xl">
                    Our Story.
                </h1>
                <p class="mb-8 font-body text-lg leading-relaxed text-gray-600 dark:text-gray-300 md:text-xl">
    ...
    <section class="py-16 md:py-24 bg-white dark:bg-[#111721]">
        <div class="mx-auto max-w-3xl px-6 text-center">
            <span class="material-symbols-outlined text-4xl text-brandLightBlue mb-6">spa</span>
            <h2 class="mb-8 font-display text-3xl font-semibold leading-snug text-[#111318] dark:text-white md:text-4xl">
            ...
            <p class="font-body text-base leading-relaxed text-gray-600 dark:text-gray-400">
    ...
    <!-- Features Grid -->
    <section class="bg-[#f8f9fa] dark:bg-[#1a212e] py-20">
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid gap-8 md:grid-cols-3">
                <!-- Card 1 -->
                <div class="group relative overflow-hidden rounded-xl bg-white dark:bg-[#111721] p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                    ...
                    <h3 class="mb-3 font-display text-2xl font-bold text-[#111318] dark:text-white">Self-Manufactured</h3>
                ...
                <div class="group relative overflow-hidden rounded-xl bg-white dark:bg-[#111721] p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                    ...
                    <h3 class="mb-3 font-display text-2xl font-bold text-[#111318] dark:text-white">Timeless Style</h3>
                    <p class="font-body text-gray-600 dark:text-gray-400">
                ...
                <div class="group relative overflow-hidden rounded-xl bg-white dark:bg-[#111721] p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                    ...
                    <h3 class="mb-3 font-display text-2xl font-bold text-[#111318] dark:text-white">Made for You</h3>
                    <p class="font-body text-gray-600 dark:text-gray-400">
        ...
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
                <div class="relative order-2 lg:order-1">
                    ...
                    <div class="absolute -bottom-6 -right-6 hidden md:block rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800 max-w-xs border border-gray-100 dark:border-gray-700">
                        <p class="font-display text-xl font-medium italic text-gray-800 dark:text-gray-100">"Attention to detail is the definition of quality."</p>
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    <h2 class="mb-6 font-display text-4xl font-bold text-[#111318] dark:text-white lg:text-5xl">The Production Process</h2>
                    <div class="space-y-6 font-body text-lg text-gray-600 dark:text-gray-300">
                        <p>
                            Being <strong class="text-[#111318] dark:text-white font-medium">self-manufactured</strong> is our superpower. It allows us to adapt quickly to emerging trends while maintaining strict quality control that mass-market brands often miss.
                        </p>
                        <p>
                        ...
                        <div class="pt-4">
                            <a href="#" class="inline-flex h-12 items-center justify-center rounded-lg bg-brandLightBlue px-8 text-base font-bold text-[#111318] transition-all hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 dark:ring-offset-[#111721]">
                                View Collections
                            </a>
                        </div>
                    </div>
    ...
    <!-- Team / Visual Break -->
    <section class="relative w-full py-20 bg-[#f8f9fa] dark:bg-[#111721]">
        <div class="mx-auto max-w-7xl px-6">
            <div class="flex flex-col items-center justify-center gap-10 lg:flex-row">
                <div class="flex-1 space-y-4 text-center lg:text-left">
                    <h2 class="font-display text-3xl font-bold text-[#111318] dark:text-white lg:text-4xl">Meet the Makers</h2>
                    <p class="font-body text-gray-600 dark:text-gray-400 max-w-md mx-auto lg:mx-0">
    ...
    <section class="py-24">
        <div class="mx-auto max-w-4xl px-6 text-center">
            <div class="rounded-3xl bg-[#f0f4fc] dark:bg-[#1e2736] px-6 py-16 md:px-12">
                <h2 class="mb-4 font-display text-3xl font-bold text-[#111318] dark:text-white md:text-4xl">Join the Maneé Community</h2>
                <p class="mb-8 font-body text-gray-600 dark:text-gray-300">
                ...
                <form class="mx-auto flex max-w-md flex-col gap-3 sm:flex-row">
                    <input class="h-12 w-full flex-1 rounded-lg border border-gray-200 bg-white px-4 text-sm outline-none focus:border-brandLightBlue focus:ring-2 focus:ring-brandLightBlue/20 dark:border-gray-700 dark:bg-[#111721] dark:text-white" placeholder="Enter your email" required="" type="email"/>
                    <button class="h-12 w-full rounded-lg bg-[#111318] px-6 font-bold text-white transition-opacity hover:opacity-90 dark:bg-white dark:text-[#111318] sm:w-auto" type="submit">
                        Subscribe
                    </button>
                </form>
            </div>
