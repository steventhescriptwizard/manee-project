...
@section('title', 'Add Category - Maneé Admin')
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="flex flex-col gap-6">
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-xl border border-slate-200 dark:border-gray-800 shadow-sm space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="w-full rounded-lg border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:ring-blue-600 focus:border-blue-600" required placeholder="e.g. Headphones">
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" class="w-full rounded-lg border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:ring-blue-600 focus:border-blue-600" placeholder="Auto-generated if left empty">
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="w-full rounded-lg border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:ring-blue-600 focus:border-blue-600">{{ old('description') }}</textarea>
            </div>
